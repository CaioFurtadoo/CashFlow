...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessage {
        ...
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a Expenses cannot be on the future.
        /// </summary>
        ...
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a Your password must be at least 8 characters long, containing at least one uppercase letter, one lowercase letter, one number, and one special character (example. ! @ # $ % ^ &amp; * ( ) , . ?  \ &lt; &gt;)).
        /// </summary>
